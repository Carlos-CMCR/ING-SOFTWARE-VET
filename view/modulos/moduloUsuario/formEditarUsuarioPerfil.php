...
<body>
    ...
    <form action="getActualizarPerfil.php" method="POST">
    ...
    <div class="card mt-5 " style="width: 65rem;">
        ...
        <div class="row">
                ...
                <div class="col-8 "><input type="email"  class="form-control" aria-describedby="passwordHelpBlock" name="correo"  id="correo" value="<?php echo $atributo['correo']; ?>"> </div>
        </div>
        </div>
        <div class="mb-2">
        <div class="row">
